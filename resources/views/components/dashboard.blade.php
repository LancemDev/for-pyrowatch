...
<div class="flex flex-col h-screen bg-gray-100">
    ...
    <div class="flex-1 flex">
        ...
        <div class="flex-1 p-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2 p-2">
                ...
                <!-- Sección 1 - Gráfica de Usuarios -->
                    <div class="bg-white p-4 rounded-md">
                        <h2 class="text-gray-500 text-lg font-semibold pb-1">First Item</h2>
                    ...
                    <div class="bg-white p-4 rounded-md">
                        <h2 class="text-gray-500 text-lg font-semibold pb-1">Second Item</h2>
            ...
            <div class="bg-white p-4 rounded-md">
                <h2 class="text-gray-500 text-lg font-semibold pb-4">Live Data Params</h2>
                <div class="my-1"></div> <!-- Espacio de separación -->
                <div class="bg-gradient-to-r from-cyan-300 to-cyan-500 h-px mb-6"></div> <!-- Línea con gradiente -->
    ...
    <h2 class="text-gray-500 text-lg font-semibold pb-4">Notification History</h2>
    <div class="my-1"></div> <!-- Espacio de separación -->
    <div class="bg-gradient-to-r from-cyan-300 to-cyan-500 h-px mb-6"></div> <!-- Línea con gradiente -->
    <table class="w-full table-auto text-sm">
            <thead>
        ...
        <!-- "View more" button for the Transactions table -->
        <div class="text-right mt-4">
            <button class="bg-cyan-500 hover:bg-cyan-600 text-white font-semibold py-2 px-4 rounded">
                View more
            </button>
